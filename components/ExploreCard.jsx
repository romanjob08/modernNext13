...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    />
    {active !== id ? (
      <h3 className="font-bold sm:text-[26px] text-[18px] sm:w-[300px] text-white
      ...
      >
        ...
        w-[60px] h-[60px] rounded-[24px] glassMorphism
        md-[16px]`}
        >
          <img
            src="/headset.svg"
        ...
        <h2 className="mt-[24px] font-semibold sm:text-[32px]
